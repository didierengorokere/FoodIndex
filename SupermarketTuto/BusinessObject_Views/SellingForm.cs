...
namespace SupermarketTuto
{
    public partial class SellingForm : Form
    {
        ...
        {
            e.Graphics.DrawString("Thank you for shopping with us", new Font("Century Gothic", 25, FontStyle.Bold), Brushes.Red, new Point(230));
            ...
            e.Graphics.DrawString("FoodIndex", new Font("Century Gothic", 20, FontStyle.Italic), Brushes.Red, new Point(270,230));
        }
